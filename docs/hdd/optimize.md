...
!!! info ""
    ...
    !!! warning
        ...
        启用高性能将时刻保持你的CPU为最高睿频状态，但也可以使你的帧生成更加稳定。13/14代 i7以上的用户，对电费敏感的同学，以及使用笔记本的同学酌情开启

    !!! tips

        如果你游戏帧率不正常（例如只能跑到50帧，90帧，跳帧很严重），并且也启用了高性能模式，大概率是电源选项隐藏属性被篡改（例如运行过早期版本的三角洲行动被修改了电源选项锁定了CPU频率）
